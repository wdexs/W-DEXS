...
import {WdexsToken} from "./WdexsToken.sol";


/**
 * @title WdexsPool contract
 *
 ...
 **/
contract WdexsPool is WdexsToken, IPool {
    ...
    function _safeTransferFrom(
        ...
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            "WdexsPool: TRANSFER_FROM_FAILED"
        );
    }
